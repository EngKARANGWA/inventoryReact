...
import ProductionPDFReport from "./BatchPDFReport";
...
const ProductionViewModal: React.FC<ProductionViewModalProps> = ({
  ...
  const totalMaterialCost = (() => {
    if (
      ...
      !production.mainProductUnitPrice
    ) {
      return 0;
    }
  ...
  const efficiencyMetrics = {
    efficiency:
      typeof production.efficiency === "number" ? production.efficiency : 0,
...
const exportToPDF = async () => {
  ...
  const htmlContent = ReactDOMServer.renderToStaticMarkup(
    <ProductionPDFReport production={production} exportDate={exportDate} />
  );
  ...
  const opt = {
    ...
    filename: `Production_Batch_${production.referenceNumber}.pdf`,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-4 md:p-6 w-full max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          <div className="space-y-6" id="production-pdf-content">
            {/* Summary Cards */}
                        ...
                        <div className="bg-gray-50 rounded p-3">
                          <div className="flex justify-between mb-1">
                            <span className="text-sm text-gray-600">
                              ...
                              {formatNumber(
                                parseFloat(
                                  production.usedQuantity?.toString() || "0"
                                )
                              )}{" "}
                              kg)
                            </span>
                          ...
                          <div className="flex justify-between text-xs text-gray-500">
                            <span>
                              ...
                              {formatCurrency(
                                parseFloat(
                                  production.mainProductUnitPrice?.toString() ||
                                    "0"
                                )
                              )}
                              /kg
